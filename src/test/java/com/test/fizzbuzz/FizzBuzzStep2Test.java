...
public class FizzBuzzStep2Test {
    {
        ...
        feature("FizzBuzz", () -> {
            ...
            scenarioOutline("should be able to identify number divisible by 3", (number, expectedBoolean) -> {
                        ...
                        Variable<FizzBuzzStep2> fizzBuzz = new Variable<>();
                        Variable<Boolean> message = new Variable<>();
                        given("fizz buzz is initialized",
                                () -> fizzBuzz.set(new FizzBuzzStep2()));
            ...
            scenarioOutline("should return proper message for a range with luck", (startFrom, take, expectedMessage) -> {
